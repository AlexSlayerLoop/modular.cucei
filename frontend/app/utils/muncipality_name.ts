export const municipalityName = (id: number): string => {
  const municipalities: Record<number, string> = {
    1: "Acatic",
    2: "Acatlán de Juárez",
  ...
  return municipalities[id] || "Unknown Municipality";
};
