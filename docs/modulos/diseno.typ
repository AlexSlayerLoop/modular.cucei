...
#figure(image("../assets/DiagramaEntidadRelacion.png"))
...
- R3 Escalabilidad y rendimiento
  ...
  Debe soportar N usuarios concurrentes (ej. 10
...
- R5 Compatibilidad e interoperabilidad
  ...
  estándar como (CSV , JSON, PDF).

== Diagramas de caso de uso
#figure(image("../assets/Diagrama_de_caso_de_uso.png"))

== Diagrama de actividades
#figure(image("../assets/ActivityDiagram.png"))

= Manual de Usuario
#include "./manual_de_usuario.typ"
